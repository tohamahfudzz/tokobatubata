...
const harga=1000;
let a=1;
const kirim=document.querySelector('#bawah #estimasi form[name="estimasi"] input[name="kirim"]');
const textP=document.querySelector('#bawah #estimasi form[name="estimasi"] p');
...
if (jumlahnya>=3000) {
hasil=hasil-(hasil*5/100);

} 


alert(`Perkiraan total harga Rp.${hasil}`);
textP.textContent=`estimasi harga:${hasil}`;
...
const total=document.querySelector('#bawah #estimasi form[name="estimasi"] input[name="jumlah"]').value;
